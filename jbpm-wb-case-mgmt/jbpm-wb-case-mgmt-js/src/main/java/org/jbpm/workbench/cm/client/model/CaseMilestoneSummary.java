...
public class CaseMilestoneSummary {
    ...
    public CaseMilestoneSummary(@MapsTo("milestone-name") String name,
                                @MapsTo("milestone-id") String identifier,
                                @MapsTo("milestone-achieved") boolean achieved,
                                @MapsTo("milestone-achieved-at") Date achievedAt,
                                @MapsTo("milestone-status") String status) {
        this.name = name;
